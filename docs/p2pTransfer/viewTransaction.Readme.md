...
transaction = mmClient.addRequest(p2PTransferRequest).viewTransaction(txnRef);
```
...
```java
{
  "transactionReference": "REF-1639639470456",
  "creditParty": [
    {
      "key": "msisdn",
      "value": "+44012345678"
  ...
  "creationDate": "2021-12-16T07:24:30",
  "modificationDate": "2021-12-16T07:24:30",
  "requestDate": "2021-12-16T07:24:30"
}
```