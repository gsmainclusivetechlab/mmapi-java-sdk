...
public class CreateDepositTransaction extends SDKClient {
	...
	public static void main(String... args) {
		try {
			...
			AsyncResponse sdkResponse = mmClient.addRequest(agentServiceRequest).addCallBack(get("CALLBACK_URL")).createDepositTransaction();
		
			System.out.println(String.format("Create Deposit Transaction Status: %s", sdkResponse.getStatus()));
