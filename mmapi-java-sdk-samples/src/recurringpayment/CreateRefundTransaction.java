...
public class CreateRefundTransaction extends SDKClient {
	...
	public static void main(String... args) {
		try {
			...
			AsyncResponse sdkResponse = mmClient.addRequest(recurringPaymentRequest).addCallBack(get("CALLBACK_URL")).createRefundTransaction();
		
			System.out.println(String.format("Refund Transaction Status: %s", sdkResponse.getStatus()));
