...
public class CreateInternationalTransaction extends SDKClient {
	...
	public static void main(String... args) {
		try {
			...
			AsyncResponse sdkResponse = mmClient.addRequest(internationalTransferRequest)
					.addCallBack(get("CALLBACK_URL")).createInternationalTransaction();

			System.out.println(String.format("Create International Transaction Status: %s", sdkResponse.getStatus()));
